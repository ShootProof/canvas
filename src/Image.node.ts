...
export default class Image implements HTMLImageElement {
  __image__: NodeImage;
  __events__: EventEmitter;
  __errorHandler__: OnErrorEventHandler;
  __loadHandler__: ((this: GlobalEventHandlers, event: Event) => any) | null;

  constructor() {
    this.__image__ = new NodeImage();
    this.__events__ = new EventEmitter();
    this.__errorHandler__ = null;
    this.__loadHandler__ = null;
    this.__image__.onload = () => {
      this.__loadHandler__?.(new NodeEvent('load', this));
      this.__events__.emit('load');
    };
    this.__image__.onerror = (error: Error) => {
      this.__errorHandler__?.(new NodeEvent('error', this), undefined, undefined, undefined, error);
      this.__events__.emit('error');
    };
  }
  ...
  set border(_value: string) {
    throw new Error('Method not implemented.');
  }

  get complete(): boolean {
    return this.__image__.complete;
  }
  ...
  get height(): number {
    return this.__image__.height;
  }

  set height(value: number) {
    this.__image__.height = value;
  }
  ...
  get naturalHeight(): number {
    return this.__image__.naturalHeight;
  }

  get naturalWidth(): number {
    return this.__image__.naturalWidth;
  }
  ...
  set sizes(_value: string) {
    throw new Error('Method not implemented.');
  }

  get src(): string {
    return this.__image__.src as string;
  }
  ...
  set vspace(_value: number) {
    throw new Error('Method not implemented.');
  }

  get width(): number {
    return this.__image__.width;
  }

  set width(value: number) {
    this.__image__.width = value;
  }
  ...
  get onload(): ((this: GlobalEventHandlers, event: Event) => any) | null {
    return this.__loadHandler__;
  }

  set onload(handler: ((this: GlobalEventHandlers, event: Event) => any) | null) {
    this.__loadHandler__ = handler;
  }
